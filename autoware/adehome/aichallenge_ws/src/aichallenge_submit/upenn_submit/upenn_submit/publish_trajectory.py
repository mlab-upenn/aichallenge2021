...
class MinimalPublisher(Node):
    ...
    def __init__(self):
        ...
        self.raceline0 = np.load(pkg_resources.resource_filename(PACKAGE_NAME,'resources/traj_race_cl_4_8_dense.npy'))
        self.raceline1 = np.load(pkg_resources.resource_filename(PACKAGE_NAME,'resources/traj_race_cl_4_8_dense.npy'))
        self.raceline_ind = 0
